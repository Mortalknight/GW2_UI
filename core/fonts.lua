...
local function LoadFonts()
    ...
    setFont(NumberFontNormal, narrow, 12, nil, 1.25, -1.25, 1)
    ...
    setFont(ErrorFont, narrow, 12, nil, 0.75, -0.75, 0.5)
    setFont(ZoneTextFont, narrow, 32, nil, 1.25, -1.25, 0.75)
    setFont(SubZoneTextFont, narrow, 24, nil, 1.25, -1.25, 0.75)
    setFont(PVPInfoTextFont, narrow, 16, nil, 1.25, -1.25, 0.75)
    setFont(RaidWarningFrameSlot1, narrow, 12, nil, 0.75, -0.75, 0.75)
    setFont(RaidWarningFrameSlot2, narrow, 12, nil, 0.75, -0.75, 0.75)
    setFont(RaidBossEmoteFrameSlot1, narrow, 12, nil, 0.75, -0.75, 0.75)
    setFont(RaidBossEmoteFrameSlot2, narrow, 12, nil, 0.75, -0.75, 0.75)
