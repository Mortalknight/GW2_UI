...
local function LoadFonts()
    ...
    setFont(System15Font_Shadow, normal, nil, "SHADOW")
    ...
    setFont(UserScaledFontNumberNormalRight, narrowBold, nil, "OUTLINE")
    setFont(UserScaledFontNumberNormalRightRed, narrowBold, nil, "OUTLINE")
    setFont(UserScaledFontNumberNormalRightYellow, narrowBold, nil, "OUTLINE")
    setFont(UserScaledFontNumberNormalRightGray, narrowBold, nil, "OUTLINE")
    setFont(UserScaledFontNumberNormalRightGreen, narrowBold, nil, "OUTLINE")

    -- user scaled: regular
    setFont(UserScaledFontGameNormalSmall, normal)
    setFont(UserScaledFontGameDisableSmall, normal)
    setFont(UserScaledFontGameHighlightSmall, normal)
    setFont(UserScaledFontGameNormal, normal)
    setFont(UserScaledFontGameDisable, normal)
    setFont(UserScaledFontGameHighlight, normal)
    setFont(UserScaledFontGameHighlightRight, normal)
    setFont(UserScaledFontGameNormalMed2, normal)
    setFont(UserScaledChatFontNormal, normal)
    setFont(UserScaledFontGame15Shadow, normal, nil, "SHADOW")
    setFont(UserScaledFontGameNormalLarge, normal)
    setFont(UserScaledFontGameHighlightLarge, normal)
    setFont(UserScaledFontSystem15Shadow, normal, nil, "SHADOW")
