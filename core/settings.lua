...
local function LoadSettings()
    ...
    GwSettingsGeneralSkinsOptionHeader:SetFont(DAMAGE_TEXT_FONT, 20)
    GwSettingsGeneralSkinsOptionHeader:SetTextColor(255 / 255, 241 / 255, 209 / 255)
    GwSettingsGeneralSkinsOptionHeader:SetText("General Skins")
    GwSettingsGeneralSkinsOptionSub:SetFont(UNIT_NAME_FONT, 12)
    GwSettingsGeneralSkinsOptionSub:SetTextColor(181 / 255, 160 / 255, 128 / 255)
    GwSettingsGeneralSkinsOptionSub:SetText("Enable or disable the skins you need and don't need.")
    ...
    _G["GwSettingsLabel9"].iconbg:SetTexture("Interface\\AddOns\\GW2_UI\\textures\\settingsiconbg-2.tga")
    ...
    local fmGCNP = CreateFrame("Button", "GwCreateNewProfile", GwSettingsProfilesframe.scrollchild, "GwCreateNewProfile")
