...
local function LoadWhoList(tabContainer)
    ...
    WhoWindow.list.ColumnHeader2.DropDown.gwHover:ClearAllPoints()
    WhoWindow.list.ColumnHeader2.DropDown.gwHover:SetPoint("TOPLEFT", WhoWindow.list.ColumnHeader2.DropDown, "TOPLEFT", 1, 0)
    WhoWindow.list.ColumnHeader2.DropDown.gwHover:SetPoint("BOTTOMRIGHT", WhoWindow.list.ColumnHeader2.DropDown, "BOTTOMRIGHT", -2, 8)
