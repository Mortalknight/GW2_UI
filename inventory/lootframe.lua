...
local function SkinLooTFrame()
    ...
    if GetCVar("lootUnderMouse") == "0" then
        ...
        RegisterMovableFrame(_G.LootFrame, BUTTON_LAG_LOOT, "LOOTFRAME_POS", "VerticalActionBarDummy", nil, nil, nil, true)
    ...
    _G.LootFrameCloseButton:SetNormalTexture("Interface\\AddOns\\GW2_UI\\textures\\window-close-button-normal")
    _G.LootFrameCloseButton:SetPushedTexture("Interface\\AddOns\\GW2_UI\\textures\\window-close-button-hover")
    _G.LootFrameCloseButton:SetHighlightTexture("Interface\\AddOns\\GW2_UI\\textures\\window-close-button-hover")
    ...
    _G.LootFrameDownButton:SetNormalTexture("Interface\\AddOns\\GW2_UI\\textures\\arrowdown_up")
    _G.LootFrameDownButton:SetPushedTexture("Interface\\AddOns\\GW2_UI\\textures\\arrowdown_up")
    _G.LootFrameDownButton:SetHighlightTexture("Interface\\AddOns\\GW2_UI\\textures\\arrowdown_up")

    _G.LootFrameUpButton:SetNormalTexture("Interface\\AddOns\\GW2_UI\\textures\\arrowup_down")
    _G.LootFrameUpButton:SetPushedTexture("Interface\\AddOns\\GW2_UI\\textures\\arrowup_down")
    _G.LootFrameUpButton:SetHighlightTexture("Interface\\AddOns\\GW2_UI\\textures\\arrowup_down")
