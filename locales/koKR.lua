...
L["Move HUD"] = "HUD 이동"
L["You cannot upgrade that item."] = "해당 아이템을 업그레이드 할 수 없습니다."
...
L["You must unequip that item in order to upgrade it."] = "해당 아이템을 업그레이드하려면 먼저 해제해야합니다."
