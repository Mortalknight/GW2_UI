...
local function GWUseThisLocalization()
	...
	L["APPLY_SCALE_TO_ALL_SCALEABELFRAMES_DESC"] = "Применяет масштаб пользовательского интерфейса ко всем фреймам, которые можно масштабировать в режиме \"Переместить HUD\". "
	...
	L["BAG_NEW_ORDER_FIRST"] = "Новые предметы в первую сумку"
	L["BAG_NEW_ORDER_LAST"] = "Новые предметы в последнюю сумку"
	...
	L["HUD_BACKGROUND"] = "Отображение фона интерфейса"
