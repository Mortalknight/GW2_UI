...
local function GWUseThisLocalization()
    ...
    L["AURAS_DESC"] = "Изменить отображение бафов и дебафов."
    L["AURAS_IGNORED"] = "Не отображать ауры"
    L["AURAS_IGNORED_DESC"] = "Никогда не показывать ауры из списка"
    L["AURAS_MISSING"] = "Не хватает бафов"
    L["AURAS_MISSING_DESC"] = "Отображать бафы из списка, только если их нет."
    L["AURAS_TOOLTIP"] = "Настроить отображение аур и индикации на панелях."
