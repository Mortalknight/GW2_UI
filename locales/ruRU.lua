...
L["Left Click to switch between Local and Realm time"] = "ЛКМ чтобы переключиться между локальным и серверным временем"
L["Shift-Click to toggle military time format"] = "Shift+ЛКМ для переключения на 24-часовой формат"
L["Right Click to open the Stopwatch"] = "ПКМ чтобы открыть секундомер"
L["Shift-Right Click to open the Time Manager"] = "Shift+ПКМ чтобы открыть будильник"
...
L["You cannot upgrade that item."] = "Этот предмет нельзя улучшить."
...
L["Sold junk for: %s"] = "Продано хлама на сумму: %s"
...
L["You must unequip that item in order to upgrade it."] = "Вы должны снять этот предмет, чтобы улучшить его."
L["Up"] = "Bверх"
