...
local function GWUseThisLocalization()
    ...
    L["AURAS_PER_ROW"] = "Auras por Coluna"
    ...
    L["RAID_AURAS_IGNORED"] = "Ignorar auras"
    L["RAID_AURAS_IGNORED_DESC"] = "Lista de nomes de auras que nunca será mostrada."
    L["RAID_AURAS_MISSING"] = "Buffs em falta."
    L["RAID_AURAS_MISSING_DESC"] = "Lista de nomes de buffs que só serão mostrados quando estão em falta."
