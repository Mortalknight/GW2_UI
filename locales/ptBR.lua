...
local function GWUseThisLocalization()
	...
	L["MINIMAP_COORDS_TOGGLE"] = "Mostrar Coordenadas no Minimapa"
	...
	L["PLAYER_DODGEBAR_SPELL"] = "Habilidade da Barra de Rastreio"
	L["PLAYER_DODGEBAR_SPELL_DESC"] = "Preencha o ID do feitiço que deve ser rastreado pela barra de rastreio.\nSe nenhum ID for colocado, as Habilidades padrão baseadas em sua especialização e talentos serão rastreadas."
