...
L["Display guild ranks if a unit is a member of a guild."] = "Muestra los rangos de hermandad se la unidad tiene una hermandad."
...
L["Display the unit role in the tooltip."] = "Muestra el role de la unidad en la sugerencia."
L["Target Info"] = "Información del Objetivo"
L["When in a raid group, show if anyone in your raid is targeting the current tooltip unit."] = "Cuando en un grupo de banda, muestra se alguien apunta a la sugerencia actual."
L["Advanced Casting Bar"] = "Barra de casteo avanzado"
L["Enable or disable the advanced casting bar."] = "Activar o desactivar la barra de casteo avanzado."
L["AFK Mode"] = "Modo AFK"
...
L["Enable the GW2 style casting bar."] = "Activar la barra de casteo de GW2 UI"
...
L["Display health as a percentage. Can be used as well as, or instead of Health Value."] = "Mostrar salud como un porcentaje. Puede usarse, o así mismo el valor de salud."
L["Show health as a numerical value."] = "Mostrar salud como un valor numérico."
...
L["Left Click to switch between Local and Realm time"] = "Clic izquierda para cambiar entre tiempo de local o reino."
L["Shift-Click to toggle military time format"] = "Mayús-Clic para pasar el formato de tiempo militar"
L["Right Click to open the Stopwatch"] = "Clic derecho para abrir el cronómetro"
L["Shift-Right Click to open the Time Manager"] = "Shift-Right Click to open the Time Manager"
...
L["Always show Minimap details."] = "Mostrar permanentemente los detalles de minimapa."
...
L["You cannot upgrade that item."] = "No puedes mejorar este objeto."
...
L["A list of buffs that should only be shown when they are missing."] = "A comma-separated list of aura names that should only be shown when they are missing."
...
L["Sold junk for: %s"] = "Se ha vendido la basura por: %s"
...
L["Scale"] = "Escala"
L["Stance Bar Position"] = "Posición de la barra de posición"
L["Set the position of the stance bar (left or right from the main action bar)."] = "Establece la posición de la barra de posición (izquierda o derecha de la barra de acción principal)."
...
L["You must unequip that item in order to upgrade it."] = "Debes quitarte este objeto para mejorarlo."
L["Up"] = "Arriba"
...
L["Show menu for placing world markers when in raids."] = "Muestra el menú para colocar marcadores del mundo en bandas."
