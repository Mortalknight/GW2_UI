...
L["Left Click to switch between Local and Realm time"] = "左鍵 切換本地和伺服器時間"
L["Shift-Click to toggle military time format"] = "Shift+左鍵 切換時間格式"
L["Right Click to open the Stopwatch"] = "右鍵 開啟碼表"
L["Shift-Right Click to open the Time Manager"] = "Shift+右鍵 開啟時間管理員"
...
L["Move HUD"] = "移動介面"
L["You cannot upgrade that item."] = "你不能升級那件物品。"
L["No Guild"] = "沒有公會"
...
L["You must unequip that item in order to upgrade it."] = "必須先脫下裝備中的物品才能升級。"
L["Up"] = "上"
