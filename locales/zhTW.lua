...
local function GWUseThisLocalization()
	...
	L["ADVANCED_TOOLTIP_SHOW_GENDER_DESC"] = "顯示玩家角色的性別。"
	...
	L["ADVANCED_TOOLTIP_SHOW_MOUNT_DESC"] = "顯示單位目前正在騎的坐騎資訊。"
	...
	L["APPLY_SCALE_TO_ALL_SCALEABELFRAMES"] = "套用介面縮放到所有可縮放的框架"
	L["APPLY_SCALE_TO_ALL_SCALEABELFRAMES_DESC"] = "介面縮放大小套用到所有在 '移動介面' 模式中能夠縮放大小的框架。"
	L["ASCENDING"] = "遞增"
	L["AURAS_PER_ROW"] = "每列光環數量"
	L["AURA_STYLE"] = "光環樣式"
	L["AUTO_REPAIR"] = "自動修裝"
	L["AUTO_REPAIR_DESC"] = "和商人對話時，依據下列規則自動修理裝備。"
	...
	L["CHAT_BUBBLES_DESC"] = "取代預設的聊天泡泡。(只在允許更改聊天泡泡的區域/副本外面)"
	L["CHAT_FADE"] = "淡出聊天視窗"
	L["CHAT_FADE_DESC"] = "非使用中時淡出聊天視窗。"
	...
	L["COMPASS_TOGGLE_DESC"] = "啟用或停用任務追蹤清單的羅盤。"
	L["COPY_OF"] = "複製的"
	...
	L["DISCORD"] = "加入 Discord"
	L["DISPLAY_PORTRAIT_DAMAGED"] = "頭像上顯示傷害"
	L["DISPLAY_PORTRAIT_DAMAGED_DESC"] = "在此框架頭像上面顯示傷害數字。"
	L["DOWN"] = "下"
	L["DOWN_AND_RIGHT"] = "右下"
	L["DYNAMIC_HUD"] = "動態 HUD 背景"
	L["DYNAMIC_HUD_DESC"] = "啟用或停用動態變換主要快捷列後方的 HUD 背景。"
	L["EXPAND_ICONS"] = "大圖示"
	L["EXPORT"] = "匯出"
	L["EXPORT_PROFILE"] = "匯出設定檔"
	L["EXPORT_PROFILE_DESC"] = "分享設定用的設定檔字串:"
	L["EXP_BAR_TOOLTIP_EXP_RESTED"] = "休息加成"
	L["EXP_BAR_TOOLTIP_EXP_RESTING"] = " (休息中)"
	L["EXTRA_AB_NAME"] = "首領按鈕"
	L["FADE_GROUP_MANAGE_FRAME"] = "淡出隊伍管理按鈕"
	L["FADE_GROUP_MANAGE_FRAME_DESC"] = "淡出隊伍管理按鈕，滑鼠游標靠近時才會顯示。"
	...
	L["HORIZONTAL"] = "水平"
	L["HUD_BACKGROUND"] = "顯示 HUD 背景"
	L["HUD_BACKGROUND_DESC"] = "在這些情況下，主要快捷列後方的 HUD 背景會隨之變化: 戰鬥中、非戰鬥中、在水中、低血量、鬼魂狀態。"
	...
	L["IMPORT"] = "匯入"
	L["IMPORT_DECODE:SUCCESSFUL"] = "匯入字串解析完成!"
	L["IMPORT_DECODE_FALIED"] = "解析設定檔錯誤: 字串無效或已損毀!"
	L["IMPORT_FAILED"] = "匯入設定檔錯誤: 字串無效或已損毀!"
	L["IMPORT_POFILE_BUTTON"] = "匯入設定檔"
	L["IMPORT_PROFILE"] = "匯入設定檔"
	L["IMPORT_PROFILE_DESC"] = "在這裡貼上設定檔字串來匯入設定檔。"
	L["IMPORT_SUCCESSFUL"] = "字串匯入完成!"
	L["INDICATORS"] = "團隊光環圖示"
	...
	L["INSTALL_CHAT_BTN"] = "設定聊天視窗"
	L["INSTALL_CHAT_DESC"] = "這部分會設定聊天視窗名稱、位置和顏色。"
	L["INSTALL_CVARS_BTN"] = "設定 CVars 遊戲預設參數"
	L["INSTALL_CVARS_DESC"] = "這部分會設定魔獸世界選項的預設值。"
	L["INSTALL_DESCRIPTION_DSC"] = "這個簡短的安裝程序，會幫你設定好使用 GW2 UI 所有需要的設定，"
	L["INSTALL_DESCRIPTION_HEADER"] = "安裝 GW2 UI "
	L["INSTALL_FINISHED_BTN"] = "結束"
	L["INSTALL_FINISHED_DESC"] = "GW2 UI 現在已經安裝完成了!"
	L["INSTALL_FINISHED_HEADER"] = "安裝完成"
	L["INSTALL_START_BTN"] = "開始安裝"
	L["INSTALL_START_HEADER"] = "安裝程序"
	L["INVENTORY_FRAME_DESC"] = "使用整合背包介面。"
	L["LEFT"] = "左側"
	L["LEVEL_REWARDS"] = "即將獲得的升級獎勵"
	L["MAINBAR_RANGE_INDICATOR"] = "主要快捷列超出範圍指示"
	...
	L["MAP_COORDINATES_TOGGLE_TEXT"] = "點一下切換坐標的精確度。"
	L["MICRO_BAR"] = "微型系統菜單"
	L["MINIMAP_COORDS"] = "坐標"
	L["MINIMAP_COORDS_TOGGLE"] = "小地圖顯示坐標"
	...
	L["PIXEL_PERFECTION_DESC"] = "介面縮放成完全符合像素的模式，會依據畫面的解析度而定。"
	...
	L["PLAYER_AURA_GROW"] = "光環延伸方向"
	L["PLAYER_BUFFS_GROW"] = "玩家增益圖示延伸方向"
	L["PLAYER_BUFF_SIZE"] = "增益圖示大小"
	L["PLAYER_DEBUFFS_GROW"] = "玩家減益圖示延伸方向"
	L["PLAYER_DEBUFF_SIZE"] = "減益圖示大小"
	L["PLAYER_DESC"] = "調整玩家框架的設定。"
	L["PLAYER_DODGEBAR_SPELL"] = "閃躲條技能"
	L["PLAYER_DODGEBAR_SPELL_DESC"] = "輸入閃躲條要追蹤的法術 ID。\n如果沒有輸入 ID，會依據你的專精和天賦來追蹤預設的技能。"
	L["PLAYER_GROUP_FRAME"] = "隊伍中也要顯示自己"
	L["PLAYER_GROUP_FRAME_DESC"] = "在隊伍框架中顯示玩家自己。"
	...
	L["QUEST_TRACKER_DESC"] = "使用重新製作加強型的任務追蹤清單。"
	...
	L["RAID_CONT_WIDTH_DESC"] = "設定整個團隊框架可以顯示的最大寬度。\n\n單位框架會隨之縮小或移動到下一列。"
	...
	L["RAID_SHOW_IMPORTEND_RAID_DEBUFFS"] = "地城 & 團隊減益"
	L["RAID_SHOW_IMPORTEND_RAID_DEBUFFS_DESC"] = "顯示重要的地城 & 團隊減益效果。"
	...
	L["RED_OVERLAY"] = "覆蓋紅色"
	L["REPAIRD_FOR"] = "已修理裝備，共支出: %s"
	L["REPAIRD_FOR_GUILD"] = "已使用公會資金修理裝備，共支出: %s"
	L["RESOURCE_DESC"] = "取代法力/能量條。"
	L["REVERSE_NEW_LOOT_TEXT"] = "拾取到最左側的背包"
	L["RIGHT"] = "右側"
	L["SECURE"] = "安全"
	L["SELLING_JUNK"] = "賣垃圾"
	L["SELLING_JUNK_FOR"] = "已賣出垃圾: %s"
	L["SEPARATE_BAGS"] = "分離背包"
	L["SEPARATE_BAGS_CHANGE_HEADER_TEXT"] = "新背包名稱"
	L["SEPARATE_BAGS_CHANGE_HEADER_TOOLTIP"] = "點一下右鍵自訂背包標題"
	...
	L["SIZER_HERO_PANEL"] = "點一下右鍵來縮放大小"
	L["SMALL_SETTINGS_DEFAULT_DESC"] = "在可移動的框架上面點右鍵以顯示更多選項。"
	L["SMALL_SETTINGS_HEADER"] = "更多框架選項"
	L["SMALL_SETTINGS_NO_SETTINGS_FOR"] = "'%s' 沒有更多的框架選項"
	L["SMALL_SETTINGS_OPTION_SCALE"] = "縮放大小"
	...
	L["TARGETED_BY"] = "被關注:"
	L["TARGET_COMBOPOINTS"] = "在目標框架顯示連擊點數"
	...
	L["TOOLTIP_ID_MODIFIER"] = "顯示 ID 的組合按鍵"
	L["TOP"] = "上方"
	L["TOTEMBAR_GROW_DIRECTION"] = "職業圖騰延伸方向"
	L["TOTEMBAR_SORTING"] = "職業圖騰排序"
	...
	L["UPDATE_STRING_3"] = "有新版本! 包含|cFFFF0000重大更新|r可供下載。\n強烈建議更新插件。"
	L["UP_AND_RIGHT"] = "右上"
	L["VENDOR_GRAYS"] = "自動賣垃圾"
	L["VERTICAL"] = "垂直"
	L["WELCOME"] = "歡迎使用"
