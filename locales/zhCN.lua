...
L["Left Click to switch between Local and Realm time"] = "鼠标左键 切换本地或服务器时间"
L["Shift-Click to toggle military time format"] = "按Shift+左键 切换时间制式"
L["Right Click to open the Stopwatch"] = "鼠标右键 打开秒表"
L["Shift-Right Click to open the Time Manager"] = "按Shift+鼠标右键 打开时钟设置"
...
L["Move HUD"] = "编辑界面"
L["You cannot upgrade that item."] = "你无法升级这个物品."
L["No Guild"] = "没有公会"
...
L["Scale"] = "缩放指数"
L["Stance Bar Position"] = "职业姿态栏位置"
L["Set the position of the stance bar (left or right from the main action bar)."] = "调整姿态栏在主动作条上的位置."
...
L["You must unequip that item in order to upgrade it."] = "你必须卸下以升级它"
L["Up"] = "上方"
