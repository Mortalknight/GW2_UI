...
L["You cannot upgrade that item."] = "Non è possibile migliorare questo oggetto."
...
L["GW2 UI Settings"] = "Impostazioni GW2 UI"
...
L["You must unequip that item in order to upgrade it."] = "Questo oggetto non può essere migliorato quando equipaggiato."
L["Up"] = "su"
