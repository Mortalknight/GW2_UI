...
local function GWUseThisLocalization()
	...
	L["RAID_AURAS_IGNORED_DESC"] = "A list of aura names that should never be shown."
	L["RAID_AURAS_MISSING"] = "Missing buffs"
	L["RAID_AURAS_MISSING_DESC"] = "A list of buff names that should only be shown when they are missing."
