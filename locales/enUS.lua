...
GwLocalization['HUD_SCALE'] = 'HUD Scale'
    GwLocalization['HUD_SCALE_LARGE'] = 'Large'
    GwLocalization['HUD_SCALE_MEDIUM'] = 'Medium'
...
GwLocalization['MINIMAP_SCALE'] = 'Minimap Scale'
    ...
    GwLocalization['MINIMAP_SCALE_SMALL'] = 'Small'
    GwLocalization['MINIMAP_SCALE_TINY'] = 'Tiny'
...
GwLocalization['PROFILES_CREATED_BY'] = 'Created by: '
...
GwLocalization['EXPAND_ICONS'] = 'Expand Icons'
GwLocalization['SORT_BAGS'] = 'Sort Bags'

-- Bank
GwLocalization['BANK_TITLE'] = 'Bank'
GwLocalization['REAGENT_BANK_TITLE'] = 'Reagent Bank'
...
GwLocalization['BANK_EXPAND_ICONS'] = 'Expand Icons'
...
GwLocalization['CHARACTER_MENU_REPS_RETURN'] = 'Character: Reputations'
...
-- Map
GwLocalization['MAP_CLOCK_TITLE'] = 'Title'
