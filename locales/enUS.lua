...
GwLocalization['ACTION_BARS_DESC'] = 'Use theGw2 UI improved action bars.' 
...
GwLocalization['CASTING_BAR_DESC'] = 'Enable theGw2 style casting bar.' 
...
GwLocalization['MINIMAP_DESC'] = 'Use theGw2 UI Minimap frame.' 
...
GwLocalization['PET_BAR_DESC'] = 'Use theGw2 UI improved Pet bar.'
...
if Locale ~= "deDE" or Local ~= "zhTW" then
