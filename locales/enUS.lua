...
L["Aura size"] = true
L["Private Auras size"] = true
L["Set the size of Private Auras on this grid."] = true
...
L["Convert old profile String"] = true
L["Convert old profile String to new one"] = true
...
L["Import string successfully converted!"] = true
L["Important"] = true
L["Indicate whether buffs you cast yourself should be separated before or after."] = true
...
L["Paste your profile string here to convert to the new format."] = true
