...
GwLocalization['FOCUS_DESC'] = 'Modifiziere die Einstellungen der Focuseinheit.'
GwLocalization['FOCUS_TOOLTIP'] = 'Bearbeite die Einstellungen der Focuseinheiten'
...
GwLocalization['HUD_MOVE_ERR'] = 'Du kannst keine Elemente während des Kampfes verschieben!' 
    ...
    GwLocalization['FOCUS_FRAME_DESC'] = 'Aktiviert das Focus Ziel.'
    ...
    GwLocalization['COMPASS_TOGGLE_DESC'] = 'Aktivere oder deaktiviere den Quest tracker Kompass.'
    GwLocalization['ADV_CAST_BAR_DESC'] = 'Aktiere oder deaktiviere die erweiterte Zauberleiste.'
