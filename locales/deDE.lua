...
GwLocalization['ACTION_BAR_FADE_DESC'] = 'Verblasset die zusätzlichen Aktionsleisten außerhalb des Kampfes.'
GwLocalization['ACTION_BARS'] = 'Aktionsleisten'
GwLocalization['ACTION_BARS_DESC'] = 'Benutze die verbesserten GW2 UI Aktionsleisten.'
GwLocalization['ADV_CAST_BAR'] = 'Erweiterter Zauberbalken'
GwLocalization['ADV_CAST_BAR_DESC'] = 'Aktiviere oder deaktiviere den erweiterten Zauberbalken.'
...
GwLocalization['BUTTON_ASSIGNMENTS'] = 'Aktionsbutton Zuweisungen'
GwLocalization['BUTTON_ASSIGNMENTS_DESC'] = 'Aktiviere oder deaktiviere die Aktionsbutton Zuweisungen'
GwLocalization['CASTING_BAR'] = 'Zauberbalken'
GwLocalization['CASTING_BAR_DESC'] = 'Aktiviere den Zauberbalken im GW2 Style.'
