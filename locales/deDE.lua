...
L["Only takes effect if the option 'Cursor Tooltips' is activated"] = "Wird nur angewendet, wenn die Option 'Tooltips an der Maus' aktiviert ist"
L["Only takes effect if the option 'Cursor Tooltips' is activated and the cursor anchor is NOT 'Cursor Anchor'"] = "Wird nur angewendet, wenn die Option 'Tooltips an der Maus' aktiviert ist und der Mausanker-Typ NICHT 'Mausanker' ist"
