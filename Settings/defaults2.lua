...
GW.globalDefault = {
    profile = {
        ...
        BAG_ITEM_JUNK_DESATURATE = false,
        BAG_ITEM_EQUIPMENT_SET_ICON_SHOW = false,
        BAG_ITEM_MARK_UNUSABLE = false,
        BAG_AUTO_SORT_ON_OPEN = false,
        BAG_AUTO_OPEN_CONTEXTS = {merchant = false, mail = false, auctionHouse = false, bank = false, trade = false},
        BAG_HEADER_NAME0= "",
        BAG_HEADER_NAME1= "",
        BAG_HEADER_NAME2= "",
        BAG_HEADER_NAME3= "",
        ...
        ALERTFRAME_NOTIFICATION_GREAT_VAULT_SOUND= "None",
