...
local function LoadHudPanel(sWindow)
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.cursedSurges.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["cursedSurges.enabled"] = true}, groupHeaderName = L["Cursed Surges"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.cursedSurges.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["cursedSurges.enabled"] = true}, groupHeaderName = L["Cursed Surges"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.cursedSurges.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["cursedSurges.enabled"] = true, ["cursedSurges.alert"] = true}, groupHeaderName = L["Cursed Surges"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.cursedSurges.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["cursedSurges.enabled"] = true, ["cursedSurges.alert"] = true}, groupHeaderName = L["Cursed Surges"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.stormarionAssault.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["stormarionAssault.enabled"] = true}, groupHeaderName = L["Stormarion Assault"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.stormarionAssault.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["stormarionAssault.enabled"] = true}, groupHeaderName = L["Stormarion Assault"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.stormarionAssault.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["stormarionAssault.enabled"] = true, ["stormarionAssault.alert"] = true}, groupHeaderName = L["Stormarion Assault"], hidden = not GW.Retail})
    ...
    worldEvents:AddOptionSlider(L["Alert Second"], L["Alert will be triggered when the remaining time is less than the set value."], {getterSetter = "weeklyEvents.stormarionAssault.alertSeconds", callback = GW.UpdateWorldEventTrackers, min = 0, max = 3600, decimalNumbers = 0, step = 1, groupHeaderName = L["Stormarion Assault"], dependence = {["stormarionAssault.enabled"] = true, ["stormarionAssault.alert"] = true}, hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.weeklyMN.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["weeklyMN.enabled"] = true}, groupHeaderName = L["Weekly Quest"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.professionsWeeklyMN.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["professionsWeeklyMN.enabled"] = true}, groupHeaderName = L["Professions Weekly Quest"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.weeklyTWW.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["weeklyTWW.enabled"] = true}, groupHeaderName = L["Weekly Quest"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.ecologicalSuccession.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["ecologicalSuccession.enabled"] = true}, groupHeaderName = L["Ecological Succession"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.nightFall.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["nightFall.enabled"] = true}, groupHeaderName = L["Nightfall"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.ringingDeeps.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["ringingDeeps.enabled"] = true}, groupHeaderName = L["Ringing Deeps"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.spreadingTheLight.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["spreadingTheLight.enabled"] = true}, groupHeaderName = L["Spreading The Light"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.underworldOperative.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["underworldOperative.enabled"] = true}, groupHeaderName = L["Underworld Operative"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.theaterTroupe.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["theaterTroupe.enabled"] = true}, groupHeaderName = L["Theater Troupe"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.theaterTroupe.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["theaterTroupe.enabled"] = true}, groupHeaderName = L["Theater Troupe"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.theaterTroupe.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["theaterTroupe.enabled"] = true, ["theaterTroupe.alert"] = true}, groupHeaderName = L["Theater Troupe"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.theaterTroupe.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["theaterTroupe.enabled"] = true, ["theaterTroupe.alert"] = true}, groupHeaderName = L["Theater Troupe"], hidden = not GW.Retail})
    worldEvents:AddOptionSlider(L["Alert Second"], L["Alert will be triggered when the remaining time is less than the set value."], {getterSetter = "weeklyEvents.theaterTroupe.alertSeconds", callback = GW.UpdateWorldEventTrackers, min = 0, max = 3600, decimalNumbers = 0, step = 1, groupHeaderName = L["Theater Troupe"], dependence = {["theaterTroupe.enabled"] = true, ["theaterTroupe.alert"] = true}, hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.communityFeast.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["communityFeast.enabled"] = true}, groupHeaderName = L["Community Feast"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.communityFeast.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["communityFeast.enabled"] = true}, groupHeaderName = L["Community Feast"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.communityFeast.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["communityFeast.enabled"] = true, ["communityFeast.alert"] = true}, groupHeaderName = L["Community Feast"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.communityFeast.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["communityFeast.enabled"] = true, ["communityFeast.alert"] = true}, groupHeaderName = L["Community Feast"], hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.dragonbaneKeep.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["dragonbaneKeep.enabled"] = true}, groupHeaderName = L["Siege On Dragonbane Keep"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.dragonbaneKeep.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["dragonbaneKeep.enabled"] = true}, groupHeaderName = L["Siege On Dragonbane Keep"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.dragonbaneKeep.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["dragonbaneKeep.enabled"] = true, ["dragonbaneKeep.alert"] = true}, groupHeaderName = L["Siege On Dragonbane Keep"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.dragonbaneKeep.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["dragonbaneKeep.enabled"] = true, ["dragonbaneKeep.alert"] = true}, groupHeaderName = L["Siege On Dragonbane Keep"], hidden = not GW.Retail})
    worldEvents:AddOptionSlider(L["Alert Second"], L["Alert will be triggered when the remaining time is less than the set value."], { getterSetter = "weeklyEvents.dragonbaneKeep.alertSeconds", callback = GW.UpdateWorldEventTrackers, min = 0, max = 3600, decimalNumbers = 0, step = 1, groupHeaderName = L["Siege On Dragonbane Keep"], dependence = {["dragonbaneKeep.enabled"] = true, ["dragonbaneKeep.alert"] = true}, hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.researchersUnderFire.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["researchersUnderFire.enabled"] = true}, groupHeaderName = L["Researchers"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.researchersUnderFire.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["researchersUnderFire.enabled"] = true}, groupHeaderName = L["Researchers"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.researchersUnderFire.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["researchersUnderFire.enabled"] = true, ["researchersUnderFire.alert"] = true}, groupHeaderName = L["Researchers"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.researchersUnderFire.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["researchersUnderFire.enabled"] = true, ["researchersUnderFire.alert"] = true}, groupHeaderName = L["Researchers"], hidden = not GW.Retail})
    worldEvents:AddOptionSlider(L["Alert Second"], L["Alert will be triggered when the remaining time is less than the set value."], { getterSetter = "weeklyEvents.researchersUnderFire.alertSeconds", callback = GW.UpdateWorldEventTrackers, min = 0, max = 3600, decimalNumbers = 0, step = 1, groupHeaderName = L["Researchers"], dependence = {["researchersUnderFire.enabled"] = true, ["researchersUnderFire.alert"] = true}, hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.timeRiftThaldraszus.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["timeRiftThaldraszus.enabled"] = true}, groupHeaderName = L["Time Rift"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.timeRiftThaldraszus.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["timeRiftThaldraszus.enabled"] = true}, groupHeaderName = L["Time Rift"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.timeRiftThaldraszus.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["timeRiftThaldraszus.enabled"] = true, ["timeRiftThaldraszus.alert"] = true}, groupHeaderName = L["Time Rift"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.timeRiftThaldraszus.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["timeRiftThaldraszus.enabled"] = true, ["timeRiftThaldraszus.alert"] = true}, groupHeaderName = L["Time Rift"], hidden = not GW.Retail})
    worldEvents:AddOptionSlider(L["Alert Second"], L["Alert will be triggered when the remaining time is less than the set value."], { getterSetter = "weeklyEvents.timeRiftThaldraszus.alertSeconds", callback = GW.UpdateWorldEventTrackers, min = 0, max = 3600, decimalNumbers = 0, step = 1, groupHeaderName = L["Time Rift"], dependence = {["timeRiftThaldraszus.enabled"] = true, ["timeRiftThaldraszus.alert"] = true}, hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.superBloom.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["superBloom.enabled"] = true}, groupHeaderName = L["Superbloom"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.superBloom.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["superBloom.enabled"] = true}, groupHeaderName = L["Superbloom"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.superBloom.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["superBloom.enabled"] = true, ["superBloom.alert"] = true}, groupHeaderName = L["Superbloom"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.superBloom.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["superBloom.enabled"] = true, ["superBloom.alert"] = true}, groupHeaderName = L["Superbloom"], hidden = not GW.Retail})
    worldEvents:AddOptionSlider(L["Alert Second"], L["Alert will be triggered when the remaining time is less than the set value."], { getterSetter = "weeklyEvents.superBloom.alertSeconds", callback = GW.UpdateWorldEventTrackers, min = 0, max = 3600, decimalNumbers = 0, step = 1, groupHeaderName = L["Superbloom"], dependence = {["superBloom.enabled"] = true, ["superBloom.alert"] = true}, hidden = not GW.Retail})
    ...
    worldEvents:AddOption(L["Desaturate Icon"], L["Desaturate the icon if the event is completed this week."], {getterSetter = "weeklyEvents.bigDig.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["bigDig.enabled"] = true}, groupHeaderName = L["Big Dig"], hidden = not GW.Retail})
    worldEvents:AddOption(COMMUNITIES_NOTIFICATION_SETTINGS_DIALOG_SETTINGS_LABEL, nil, {getterSetter = "weeklyEvents.bigDig.alert", callback = GW.UpdateWorldEventTrackers, dependence = {["bigDig.enabled"] = true}, groupHeaderName = L["Big Dig"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Flash taskbar on reminder"], nil, {getterSetter = "weeklyEvents.bigDig.flashTaskbar", callback = GW.UpdateWorldEventTrackers, dependence = {["bigDig.enabled"] = true, ["bigDig.alert"] = true}, groupHeaderName = L["Big Dig"], hidden = not GW.Retail})
    worldEvents:AddOption(L["Stop alert if completed"], L["Stop alert when the event is completed in this week."], {getterSetter = "weeklyEvents.bigDig.stopAlertIfCompleted", callback = GW.UpdateWorldEventTrackers, dependence = {["bigDig.enabled"] = true, ["bigDig.alert"] = true}, groupHeaderName = L["Big Dig"], hidden = not GW.Retail})
    worldEvents:AddOptionSlider(L["Alert Second"], L["Alert will be triggered when the remaining time is less than the set value."], { getterSetter = "weeklyEvents.bigDig.alertSeconds", callback = GW.UpdateWorldEventTrackers, min = 0, max = 3600, decimalNumbers = 0, step = 1, groupHeaderName = L["Big Dig"], dependence = {["bigDig.enabled"] = true, ["bigDig.alert"] = true}, hidden = not GW.Retail})
