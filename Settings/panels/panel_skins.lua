...
local function LoadSkinsPanel(sWindow)
    ...
    general:AddOption(L["Looking for Group notifications"], nil, {getterSetter = "skins.lfgFrames.enabled", callback = function() GW.ShowRlPopup = true end, hidden = GW.Classic or GW.TBC})
    ...
    gameFrames:AddOption(BARBERSHOP, nil, {getterSetter = "skins.barberShop.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    gameFrames:AddOption(INSPECT, nil, {getterSetter = "skins.inspection.enabled", callback = function() GW.ShowRlPopup = true end})
    gameFrames:AddOption(DRESSUP_FRAME, nil, {getterSetter = "skins.dressUp.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    gameFrames:AddOption(L["Socket Frame"], nil, {getterSetter = "skins.socket.enabled", callback = function() GW.ShowRlPopup = true end, hidden = GW.Classic or GW.TBC or GW.Wrath or GW.Forever})
    gameFrames:AddOption(WORLDMAP_BUTTON, nil, {getterSetter = "skins.worldmap.enabled", callback = function() GW.ShowRlPopup = true end})
    gameFrames:AddOption(L["BG Map"], nil, {getterSetter = "skins.battlefieldMap.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    ...
    gameFrames:AddOption(COOLDOWN_VIEWER_LABEL or "Cooldown Manager", nil, {getterSetter = "skins.cooldownManager.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    gameFrames:AddOption(DEATH_RECAP_TITLE, nil, {getterSetter = "skins.deathRecap.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    ...
    gameFrames:AddOption(GW.NewSign .. COLLECTIONS, nil, {getterSetter = "skins.collections.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    ...
    gameFrames:AddOption(TALENTS, nil, {getterSetter = "skins.playerSpells.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    gameFrames:AddOption(AUCTIONS, nil, {getterSetter = "skins.auctionHouse.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    ...
    gameFrames:AddOption(GW.NewSign .. (DAMAGE_METER_LABEL or ""), nil, {getterSetter = "skins.damageMeter.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    gameFrames:AddOption(GW.NewSign .. L["Calendar"], nil, {getterSetter = "skins.calendar.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
