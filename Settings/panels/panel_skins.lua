...
local function LoadSkinsPanel(sWindow)
    ...
    general:AddOption(L["Talking Head"], nil, {getterSetter = "skins.talkingHead.enabled", callback = function() GW.ShowRlPopup = true end, hidden = not GW.isModern})
    ...
    gameFrames:AddOption(L["Socket Frame"], nil, {getterSetter = "skins.socket.enabled", callback = function() GW.ShowRlPopup = true end, hidden = GW.Classic or GW.TBC or GW.Wrath})
