...
local function LoadSkinsPanel(sWindow)
    ...
    gameFrames:AddOption(INSPECT, nil, {getterSetter = "INSPECTION_SKIN_ENABLED", callback = function() GW.ShowRlPopup = true end})
    ...
    gameFrames:AddOption(GW.NewSign .. COLLECTIONS, nil, {getterSetter = "COLLECTIONS_SKIN_ENABLED", callback = function() GW.ShowRlPopup = true end, hidden = not GW.Retail})
