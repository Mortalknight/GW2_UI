...
local function LoadInterfaceFeaturesPanel(sWindow)
    ...
    p:AddOption(L["Missing enchant and socket warning"], L["Marks enchantable slots without an enchant and empty sockets in red."], {getterSetter = "CHARACTER_ITEM_INFO_MISSING", callback = function() GW.ToggleCharacterItemInfo() end, groupHeaderName = L["UI Windows"], hidden = not GW.Retail, dependence = {["USE_CHARACTER_WINDOW"] = true, ["SHOW_CHARACTER_ITEM_INFO"] = true}})
    p:AddOption(L["Color item level by equipped average"], L["Colors the slot item level green above, yellow slightly below and red well below your equipped average item level."], {getterSetter = "CHARACTER_ITEMLEVEL_RELATIVE_COLOR", callback = function() GW.ToggleCharacterItemInfo() end, groupHeaderName = L["UI Windows"], hidden = GW.Classic or GW.TBC or GW.Wrath, dependence = {["USE_CHARACTER_WINDOW"] = true, ["SHOW_CHARACTER_ITEM_INFO"] = true}})
