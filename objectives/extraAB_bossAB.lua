...
local function ExtraAB_BossAB_Setup()
    ...
    RegisterMovableFrame(ExtraActionBarHolder, L["EXTRA_AB_NAME"], "ExtraActionBarFramePos", "VerticalActionBarDummy", nil, nil, nil, {"scaleable"})
    RegisterMovableFrame(ZoneAbilityHolder, L["ZONE_ANILITY_AB_NAME"], "ZoneAbilityFramePos", "VerticalActionBarDummy", nil, nil, nil, {"scaleable"})
