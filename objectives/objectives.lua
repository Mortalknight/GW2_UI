...
local function LoadQuestTracker()
    ...
    fNotify.title:SetFont(UNIT_NAME_FONT, 16)
    fNotify.title:SetShadowOffset(1, -1)
    fNotify.desc:SetFont(UNIT_NAME_FONT, 14)
    ...
    fCampaign.header.title:SetFont(UNIT_NAME_FONT, 16)
    ...
    fQuest.header.title:SetFont(UNIT_NAME_FONT, 16)
