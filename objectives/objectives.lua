...
local function CreateObjectiveNormal(name, parent)
    ...
    f.ObjectiveText:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_NORMAL_SIZE,GW.settings.FONTS_OUTLINE)
    f.ObjectiveText:SetShadowOffset(-1, 1)
    f.StatusBar.progress:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_SMALL_SIZE,GW.settings.FONTS_OUTLINE)
    f.StatusBar.progress:SetShadowOffset(-1, 1)
    f.TimerBar.Label:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_SMALL_SIZE,GW.settings.FONTS_OUTLINE)
...
local function CreateTrackerObject(name, parent)
    ...
    f.SubHeader:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_NORMAL_SIZE,GW.settings.FONTS_OUTLINE)
...
local function LoadQuestTracker()
    ...
    fNotify.desc:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_NORMAL_SIZE,GW.settings.FONTS_OUTLINE)
