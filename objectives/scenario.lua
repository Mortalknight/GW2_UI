...
local function LoadScenarioFrame()
    ...
    timerBlock.timerlabel:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_SMALL_SIZE,GW.settings.FONTS_OUTLINE)
    timerBlock.timerlabel:SetTextColor(1, 1, 1)
    timerBlock.timerlabel:SetShadowOffset(1, -1)
    timerBlock.timerString:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_SMALL_SIZE,GW.settings.FONTS_OUTLINE)
    timerBlock.timerString:SetTextColor(1, 1, 1)
    timerBlock.timerString:SetShadowOffset(1, -1)
    timerBlock.timerStringChest2:SetFont(DAMAGE_TEXT_FONT, 10)
    ...
    timerBlock.timerStringChest3:SetFont(DAMAGE_TEXT_FONT, 10)
    ...
    timerBlock.deathcounter.counterlabel:SetFont(DAMAGE_TEXT_FONT, 10)
    ...
    timerBlock.score.scoreString:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_SMALL_SIZE,GW.settings.FONTS_OUTLINE)
    timerBlock.score.scorelabel:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_SMALL_SIZE,GW.settings.FONTS_OUTLINE)
    ...
    newBlock.delvesFrame.deathCounter.counter:SetFont(DAMAGE_TEXT_FONT, GW.settings.FONTS_NORMAL_SIZE, GW.settings.FONTS_OUTLINE)
