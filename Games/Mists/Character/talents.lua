...
local function LoadTalents(tabContainer)
    ...
    talentContainer.topBar.unspentPoints:GwSetFontTemplate(DAMAGE_TEXT_FONT, GW.Enum.TextSizeType.Normal, "OUTLINE")
    talentContainer.topBar.unspentPoints:SetTextColor(0.87, 0.74, 0.29, 1)
    talentContainer.topBar.clearInfo:GwSetFontTemplate(DAMAGE_TEXT_FONT, GW.Enum.TextSizeType.Small, "OUTLINE")
    ...
    for i = 1, specs do
        ...
        for row = 1, maxTalentRows do
            ...
            if i == 1 then
                ...
                numberDisplay.title:GwSetFontTemplate(DAMAGE_TEXT_FONT, GW.Enum.TextSizeType.Normal)
    ...
    talentContainer:RegisterEvent("LEARNED_SPELL_IN_SKILL_LINE")
    ...
    item = CreateFrame("Button", nil, fmMenu, "GwCharacterPanelMenuButtonTemplate,SecureActionButtonTemplate")
    item:SetAttribute("macrotext", "/click PlayerTalentFrameTab1\n/click PlayerTalentFrameTab4")
    item:SetAttribute("type", "macro")
    item:RegisterForClicks("AnyDown")
