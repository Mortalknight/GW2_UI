...
function gw_getUnitBuffs(unit)
    ...
    for i=1,40 do
        if  UnitBuff(unit,i) then
            buffLists[unit][i] ={}
            buffLists[unit][i]['name'],  buffLists[unit][i]['icon'],  buffLists[unit][i]['count'],  buffLists[unit][i]['dispelType'],  buffLists[unit][i]['duration'],  buffLists[unit][i]['expires'],  buffLists[unit][i]['caster'],  buffLists[unit][i]['isStealable'],  buffLists[unit][i]['shouldConsolidate'],  buffLists[unit][i]['spellID']  =  UnitBuff(unit,i) 
            buffLists[unit][i]['key'] = i

            if buffLists[unit][i]['expires'] ~= nil then
...
function gw_getUnitDebuffs(unit)
    ...
    for i=1,40 do
        ...
        if  UnitDebuff(unit,i)  then
            ...
            DebuffLists[unit][i] ={}
            DebuffLists[unit][i]['name'],  DebuffLists[unit][i]['icon'],  DebuffLists[unit][i]['count'],  DebuffLists[unit][i]['dispelType'],  DebuffLists[unit][i]['duration'],  DebuffLists[unit][i]['expires'],  DebuffLists[unit][i]['caster'],  DebuffLists[unit][i]['isStealable'],  DebuffLists[unit][i]['shouldConsolidate'],  DebuffLists[unit][i]['spellID']  =  UnitDebuff(unit,i)
            DebuffLists[unit][i]['key'] = i

            if DebuffLists[unit][i]['expires'] ~= nil then
