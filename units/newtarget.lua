...
function gw_registerNewUnitFrame(unitToWatch, frameType)
    ...
    targetF:SetPoint(
        gwGetSetting(unitToWatch .. "_pos")["point"],
        UIParent,
        gwGetSetting(unitToWatch .. "_pos")["relativePoint"],
        gwGetSetting(unitToWatch .. "_pos")["xOfs"],
        gwGetSetting(unitToWatch .. "_pos")["yOfs"]
    )
...
function updatHealthValues(thisName, unitToWatch, noAnimation)
    ...
    addToAnimation(
        ...
        function()
            ...
            local candy =
                lerp(
                animations[unitToWatch .. "healthAnimation"]["from"],
                animations[unitToWatch .. "healthAnimation"]["to"],
                (GetTime() - animations[unitToWatch .. "healthAnimation"]["start"]) /
                    animations[unitToWatch .. "healthAnimation"]["duration"]
            )
    ...
    if isFriend then
        if _G[thisName .. "HealthBarSpark"] then
            _G[thisName .. "HealthBarSpark"]:SetVertexColor(
                GW_COLOR_FRIENDLY[1].r,
                GW_COLOR_FRIENDLY[1].g,
                GW_COLOR_FRIENDLY[1].b
            )
            ...
            _G[thisName .. "HealthBar"]:SetStatusBarColor(
                GW_COLOR_FRIENDLY[1].r,
                GW_COLOR_FRIENDLY[1].g,
                GW_COLOR_FRIENDLY[1].b
            )
