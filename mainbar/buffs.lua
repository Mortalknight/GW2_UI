...
function gw_get_buffs(unit,filter)
    ...
    for i=1, 40 do
        ...
        if UnitBuff(unit, i, filter)~=nil  then 
            ...
            auraList[i]['name'],auraList[i]['icon'],auraList[i]['count'],auraList[i]['dispelType'],auraList[i]['duration'],auraList[i]['expires'],auraList[i]['caster'],auraList[i]['isStealable'],auraList[i]['shouldConsolidate'],auraList[i]['spellID']  =  UnitBuff(unit,i,filter)  

            if auraList[i]['expires'] ~= nil then
...
function gw_get_debuffs(unit,filter)
    ...
    for i=1,40 do
        ...
        if UnitDebuff(unit,i,filter)~=nil  then 
            ...
            auraList[i]['name'],auraList[i]['icon'],auraList[i]['count'],auraList[i]['dispelType'],auraList[i]['duration'],auraList[i]['expires'],auraList[i]['caster'],auraList[i]['isStealable'],auraList[i]['shouldConsolidate'],auraList[i]['spellID']  =  UnitDebuff(unit,i,filter)  
