...
function gw_create_pet_frame()
    ...
    playerPetFrame:RegisterEvent('UNIT_POWER_UPDATE')
...
function gw_create_power_bar()
    ...
    playerPowerBar:RegisterEvent("UNIT_POWER_UPDATE");
...
function gw_dodgebar_onevent(self,event,unit)
    ...
    elseif  event == 'CHARACTER_POINTS_CHANGED' or event == 'PLAYER_ENTERING_WORLD' then
