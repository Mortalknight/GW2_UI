...
function gw_create_pet_frame()
    ...
    _G["GwPlayerPetFrameHealth"]:SetStatusBarColor(
    ...
    GwPlayerPetFrame:SetPoint(
        gwGetSetting("pet_pos")["point"],
        UIParent,
        gwGetSetting("pet_pos")["relativePoint"],
        gwGetSetting("pet_pos")["xOfs"],
        gwGetSetting("pet_pos")["yOfs"]
    )
