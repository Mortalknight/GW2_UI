...
local function LoadActionbarPanel(sWindow)
    ...
    addOptionSlider(general.scroll.scrollchild, L["Empty slots alpha"], L["Set the empty action bar slots alpha value."], { getterSetter = "ACTIONBAR_BACKGROUND_ALPHA", callback = function() GW.UpdateMainBarHot(); GW.UpdateMultibarButtons() end, min = 0, max = 1, decimalNumbers = 1, step = 0.1, dependence = {["ACTIONBARS_ENABLED"] = true}, hidden = GW.Retail})
    ...
    -- MAINBAR
    addOptionSlider(mainBar.scroll.scrollchild, L["Button Spacing"], nil, { getterSetter = "MAINBAR_MARGIIN", callback = function() GW.UpdateMainBarHot() end, min = 0, max = 10, decimalNumbers = 1, step = 0.1, dependence = (function() local t = {["ACTIONBARS_ENABLED"] = true} if GW.Retail then t["BAR_LAYOUT_ENABLED"] = true end return t end)()})
    ...
    --EXTRABARS
    addOptionSlider(extraBars.scroll.scrollchild, L["Button Spacing"], nil, { getterSetter = "MULTIBAR_MARGIIN", callback = function() GW.UpdateMultibarButtons() end, min = 0, max = 10, decimalNumbers = 1, step = 0.1, dependence = (function() local t = {["ACTIONBARS_ENABLED"] = true} if GW.Retail then t["BAR_LAYOUT_ENABLED"] = true end return t end)()})

        --Classic
        addOption(extraBars.scroll.scrollchild, SHOW_MULTIBAR1_TEXT, OPTION_TOOLTIP_SHOW_MULTIBAR1, { getterSetter = "GW_SHOW_MULTI_ACTIONBAR_1", callback = function(toSet)
        ...
        addOption(extraBars.scroll.scrollchild, SHOW_MULTIBAR2_TEXT, OPTION_TOOLTIP_SHOW_MULTIBAR2, { getterSetter = "GW_SHOW_MULTI_ACTIONBAR_2", callback = function(toSet)
                if toSet then SHOW_MULTI_ACTIONBAR_2 = "1" else SHOW_MULTI_ACTIONBAR_2 = nil end
                SetActionBarToggles(GW.settings.GW_SHOW_MULTI_ACTIONBAR_1, GW.settings.GW_SHOW_MULTI_ACTIONBAR_2, GW.settings.GW_SHOW_MULTI_ACTIONBAR_3, GW.settings.GW_SHOW_MULTI_ACTIONBAR_4, GW.settings.HIDEACTIONBAR_BACKGROUND_ENABLED)
                MultiActionBar_Update() end, dependence = {["ACTIONBARS_ENABLED"] = true}, incompatibleAddons = "Actionbars", hidden = GW.Retail})
        addOption(extraBars.scroll.scrollchild, SHOW_MULTIBAR3_TEXT, OPTION_TOOLTIP_SHOW_MULTIBAR3, { getterSetter = "GW_SHOW_MULTI_ACTIONBAR_3", callback = function(toSet)
                if toSet then SHOW_MULTI_ACTIONBAR_3 = "1" else SHOW_MULTI_ACTIONBAR_3 = nil end
                SetActionBarToggles(GW.settings.GW_SHOW_MULTI_ACTIONBAR_1, GW.settings.GW_SHOW_MULTI_ACTIONBAR_2, GW.settings.GW_SHOW_MULTI_ACTIONBAR_3, GW.settings.GW_SHOW_MULTI_ACTIONBAR_4, GW.settings.HIDEACTIONBAR_BACKGROUND_ENABLED)
                MultiActionBar_Update() end, dependence = {["ACTIONBARS_ENABLED"] = true}, incompatibleAddons = "Actionbars", hidden = GW.Retail})
        addOption(extraBars.scroll.scrollchild, SHOW_MULTIBAR4_TEXT, OPTION_TOOLTIP_SHOW_MULTIBAR4, { getterSetter = "GW_SHOW_MULTI_ACTIONBAR_4", callback = function(toSet)
    ...
    --TOTEMBAR
    addOptionDropdown(totemBar.scroll.scrollchild, L["Class Totems Sorting"], nil, { getterSetter = "TotemBar_SortDirection", callback = function() GW.UpdateTotembar(GW_TotemBar) end, optionsList = {"ASC", "DSC"}, optionNames = {L["Ascending"], L["Descending"]}, dependence = {["HEALTHGLOBE_ENABLED"] = true}, hidden = GW.Classic})
    addOptionDropdown(totemBar.scroll.scrollchild, L["Class Totems Growth Direction"], nil, { getterSetter = "TotemBar_GrowDirection", callback = function() GW.UpdateTotembar(GW_TotemBar) end, optionsList = {"HORIZONTAL", "VERTICAL"}, optionNames = {L["Horizontal"], L["Vertical"]}, dependence = {["HEALTHGLOBE_ENABLED"] = true}, hidden = GW.Classic})

    -- STANCEBAR
    addOption(stanceBar.scroll.scrollchild, ENABLE, nil, { getterSetter = "StanceBarEnabled", callback = function() GW.UpdateStanceBarVisibility(GwStanceBar) end, dependence = (function() local t = {["ACTIONBARS_ENABLED"] = true} if GW.Retail then t["BAR_LAYOUT_ENABLED"] = true end return t end)(), incompatibleAddons = "Actionbars"})
    addOptionDropdown(stanceBar.scroll.scrollchild, L["Class Totems Growth Direction"], L["Set the growth direction of the stance bar"], { getterSetter = "StanceBar_GrowDirection", callback = function() GW.SetStanceButtons(GwStanceBar) end, optionsList = {"UP", "DOWN", "LEFT", "RIGHT"}, optionNames = {StrUpper(L["Up"], 1, 1), StrUpper(L["Down"], 1, 1), L["Left"], L["Right"]}, dependence = (function() local t = {["ACTIONBARS_ENABLED"] = true, ["StanceBarEnabled"] = true} if GW.Retail then t["BAR_LAYOUT_ENABLED"] = true end return t end)(), incompatibleAddons = "Actionbars"})
