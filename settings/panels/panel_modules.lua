...
local function LoadModulesPanel(sWindow)
    ...
    p:AddOption(FOCUS, L["Enable the focus target frame replacement."], {getterSetter = "FOCUS_ENABLED", callback = function() GW.ShowRlPopup = true end, hidden = GW.Classic or GW.TBC})
    ...
    p:AddOption(BINDING_NAME_TOGGLECHARACTER3, L["Use the GW2 UI improved Pet bar."], {getterSetter = "PETBAR_ENABLED", callback = function() GW.ShowRlPopup = true end, incompatibleAddons = "Actionbars"})
