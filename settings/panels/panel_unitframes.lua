...
local function LoadTargetPanel(sWindow)
    ...
    pPlayerPet:AddOption(GW.NewSign .. L["Pandemic Highlight"], L["Highlights your own auras while they are inside their refresh window, where refreshing adds the remaining time on top."], {getterSetter = "PET_PANDEMIC_HIGHLIGHT", callback = GW.UpdateAuraOptionHolders, dependence = {["PETBAR_ENABLED"] = true}, hidden = not GW.Retail})
    pPlayerPet:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "PET_DISPEL_ICON", callback = GW.UpdateAuraOptionHolders, dependence = {["PETBAR_ENABLED"] = true}, hidden = not GW.Retail})
    ...
    p_target:AddOption(GW.NewSign .. L["Pandemic Highlight"], L["Highlights your own auras while they are inside their refresh window, where refreshing adds the remaining time on top."], {getterSetter = "target_PANDEMIC_HIGHLIGHT", callback = GW.UpdateAuraOptionHolders, dependence = {["TARGET_ENABLED"] = true}, hidden = not GW.Retail})
    p_target:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "target_DISPEL_ICON", callback = GW.UpdateAuraOptionHolders, dependence = {["TARGET_ENABLED"] = true}, hidden = not GW.Retail})
    ...
    pTargetOfTarget:AddOption(L["Show absorb bar"], nil, {getterSetter = "target_TARGET_SHOW_ABSORB_BAR", callback = function() GwTargetTargetUnitFrame:ToggleSettings() end, dependence = {["TARGET_ENABLED"] = true, ["target_TARGET_ENABLED"] = true}, hidden = GW.Classic or GW.TBC or GW.Wrath})
    ...
    p_focus:AddOption(GW.NewSign .. L["Pandemic Highlight"], L["Highlights your own auras while they are inside their refresh window, where refreshing adds the remaining time on top."], {getterSetter = "focus_PANDEMIC_HIGHLIGHT", callback = GW.UpdateAuraOptionHolders, dependence = {["FOCUS_ENABLED"] = true}, hidden = not GW.Retail})
    p_focus:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "focus_DISPEL_ICON", callback = GW.UpdateAuraOptionHolders, dependence = {["FOCUS_ENABLED"] = true}, hidden = not GW.Retail})
    ...
    pTargetOfFocus:AddOption(L["Show absorb bar"], nil, {getterSetter = "focus_TARGET_SHOW_ABSORB_BAR", callback = function() GwFocusTargetUnitFrame:ToggleSettings() end, dependence = {["FOCUS_ENABLED"] = true, ["focus_TARGET_ENABLED"] = true}, hidden = GW.Classic or GW.TBC or GW.Wrath})

    pTargetOfFocus:AddGroupHeader(L["Fader"], {hidden = GW.Classic})
    pTargetOfFocus:AddOptionDropdown(L["Fader"], nil, {
        getterSetter = "focustargetFrameFader",
        callback = function()
        ...
        dependence = {["FOCUS_ENABLED"] = true, ["focus_TARGET_ENABLED"] = true},
        checkbox = true,
        groupHeaderName = L["Fader"],
        hidden = GW.Classic
    })
    pTargetOfFocus:AddOptionSlider(L["Smooth"], nil, { getterSetter = "focustargetFrameFader.smooth", callback = function() GwFocusTargetUnitFrame:ToggleSettings() end, min = 0, max = 3, decimalNumbers = 2, step = 0.01, groupHeaderName = L["Fader"], dependence = {["FOCUS_ENABLED"] = true, ["focus_TARGET_ENABLED"] = true}, hidden = GW.Classic})
    pTargetOfFocus:AddOptionSlider(L["Min Alpha"], nil, { getterSetter = "focustargetFrameFader.minAlpha", callback = function() GwFocusTargetUnitFrame:ToggleSettings() end, min = 0, max = 1, decimalNumbers = 2, step = 0.01, groupHeaderName = L["Fader"], dependence = {["FOCUS_ENABLED"] = true, ["focus_TARGET_ENABLED"] = true}, hidden = GW.Classic})
    pTargetOfFocus:AddOptionSlider(L["Max Alpha"], nil, { getterSetter = "focustargetFrameFader.maxAlpha", callback = function() GwFocusTargetUnitFrame:ToggleSettings() end, min = 0, max = 1, decimalNumbers = 2, step = 0.01, groupHeaderName = L["Fader"], dependence = {["FOCUS_ENABLED"] = true, ["focus_TARGET_ENABLED"] = true}, hidden = GW.Classic})
    ...
    party:AddOption(GW.NewSign .. L["Pandemic Highlight"], L["Highlights your own auras while they are inside their refresh window, where refreshing adds the remaining time on top."], {getterSetter = "PARTY_PANDEMIC_HIGHLIGHT", callback = GW.UpdateAuraOptionHolders, dependence = {["PARTY_FRAMES"] = true, ["RAID_STYLE_PARTY"] = false}, hidden = not GW.Retail})
    party:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "PARTY_DISPEL_ICON", callback = GW.UpdateAuraOptionHolders, dependence = {["PARTY_FRAMES"] = true, ["RAID_STYLE_PARTY"] = false}, hidden = not GW.Retail})
