...
local function LoadTargetPanel(sWindow)
    ...
    pPlayerPet:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "PET_DISPEL_ICON", callback = GW.UpdateAuraOptionRegions, dependence = {["PETBAR_ENABLED"] = true}, hidden = not GW.Retail})
    ...
    p_target:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "target_DISPEL_ICON", callback = GW.UpdateAuraOptionRegions, dependence = {["TARGET_ENABLED"] = true}, hidden = not GW.Retail})
    ...
    p_focus:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "focus_DISPEL_ICON", callback = GW.UpdateAuraOptionRegions, dependence = {["FOCUS_ENABLED"] = true}, hidden = not GW.Retail})
    ...
    party:AddOption(GW.NewSign .. L["Show Dispel Type Icon"], L["Shows the dispel type of auras as a small icon in the corner of the aura."], {getterSetter = "PARTY_DISPEL_ICON", callback = GW.UpdateAuraOptionRegions, dependence = {["PARTY_FRAMES"] = true, ["RAID_STYLE_PARTY"] = false}, hidden = not GW.Retail})
