...
local function LoadHudPanel(sWindow)
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "stormarionAssault.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["stormarionAssault.enabled"] = true}, groupHeaderName = L["Stormarion Assault"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "weeklyMN.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["weeklyMN.enabled"] = true}, groupHeaderName = L["Weekly Quest"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "professionsWeeklyMN.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["professionsWeeklyMN.enabled"] = true}, groupHeaderName = L["Professions Weekly Quest"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "khazAlgarEmissary.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["khazAlgarEmissary.enabled"] = true}, groupHeaderName = L["Khaz Algar Emissary"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "ringingDeeps.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["ringingDeeps.enabled"] = true}, groupHeaderName = L["Ringing Deeps"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "spreadingTheLight.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["spreadingTheLight.enabled"] = true}, groupHeaderName = L["Spreading The Light"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "underworldOperative.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["underworldOperative.enabled"] = true}, groupHeaderName = L["Underworld Operative"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "theaterTroupe.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["theaterTroupe.enabled"] = true}, groupHeaderName = L["Theater Troupe"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "communityFeast.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["communityFeast.enabled"] = true}, groupHeaderName = L["Community Feast"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "dragonbaneKeep.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["dragonbaneKeep.enabled"] = true}, groupHeaderName = L["Siege On Dragonbane Keep"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "researchersUnderFire.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["researchersUnderFire.enabled"] = true}, groupHeaderName = L["Researchers"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "timeRiftThaldraszus.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["timeRiftThaldraszus.enabled"] = true}, groupHeaderName = L["Time Rift"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "superBloom.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["superBloom.enabled"] = true}, groupHeaderName = L["Superbloom"], hidden = not GW.Retail})
    ...
    worldmap:AddOption(L["Desaturate icon"], L["Desaturate icon if the event is completed in this week."], {getterSetter = "bigDig.desaturate", callback = GW.UpdateWorldEventTrackers, dependence = {["bigDig.enabled"] = true}, groupHeaderName = L["Big Dig"], hidden = not GW.Retail})
