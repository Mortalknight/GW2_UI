...
local function LoadRaid10Profile(panel)
    ...
    addOption(raid10.scroll.scrollchild, L["Shorten health values"], nil, {getterSetter = "RAID_SHORT_HEALTH_VALUES_RAID10", callback = function() GW.UpdateGridSettings("RAID10") end, dependence = {["RAID_FRAMES"] = true, ["RAID10_ENABLED"] = true}})
    ...
    addOptionDropdown(raid10.scroll.scrollchild, L["Show Country Flag"], L["Display a country flag based on the unit's language"], { getterSetter = "RAID_UNIT_FLAGS_RAID10", callback = function() GW.UpdateGridSettings("RAID10") end, optionsList = {"NONE", "DIFFERENT", "ALL"}, optionNames = {NONE_KEY, L["Different Than Own"], ALL}, dependence = {["RAID_FRAMES"] = true, ["RAID10_ENABLED"] = true}})
    ...
    addOptionDropdown(raid10.scroll.scrollchild, GW.NewSign .. L["Fader"], nil, { getterSetter = "grid10FrameFader", callback = function() GW.UpdateGridSettings("RAID10") end, optionsList = {"casting", "combat", "hover", "dynamicflight", "health"}, optionNames = {L["Casting"], COMBAT, L["Hover"], DYNAMIC_FLIGHT, HEALTH}, dependence = {["RAID_FRAMES"] = true, ["RAID10_ENABLED"] = true, ["grid10FrameFaderRange"] = false}, checkbox = true, groupHeaderName = L["Fader"]})
...
local function LoadRaid25Profile(panel)
    ...
    addOption(raid25.scroll.scrollchild, L["Shorten health values"], nil, {getterSetter = "RAID_SHORT_HEALTH_VALUES_RAID25", callback = function() GW.UpdateGridSettings("RAID25") end, dependence = {["RAID_FRAMES"] = true, ["RAID25_ENABLED"] = true}})
    ...
    addOptionDropdown(raid25.scroll.scrollchild, GW.NewSign .. L["Fader"], nil, { getterSetter = "grid25FrameFader", callback = function() GW.UpdateGridSettings("RAID25") end, optionsList = {"casting", "combat", "hover", "dynamicflight", "health"}, optionNames = {L["Casting"], COMBAT, L["Hover"], DYNAMIC_FLIGHT, HEALTH}, dependence = {["RAID_FRAMES"] = true, ["RAID25_ENABLED"] = true, ["raid25FrameFaderRange"] = false}, checkbox = true, groupHeaderName = L["Fader"]})
...
local function LoadRaid40Profile(panel)
    ...
    addOption(raid40.scroll.scrollchild, L["Shorten health values"], nil, {getterSetter = "RAID_SHORT_HEALTH_VALUES", callback = function() GW.UpdateGridSettings("RAID40") end, dependence = {["RAID_FRAMES"] = true}})
    ...
    addOptionDropdown(raid40.scroll.scrollchild, GW.NewSign .. L["Fader"], nil, { getterSetter = "grid40FrameFader", callback = function() GW.UpdateGridSettings("RAID40") end, optionsList = {"casting", "combat", "hover", "dynamicflight", "health"}, optionNames = {L["Casting"], COMBAT, L["Hover"], DYNAMIC_FLIGHT, HEALTH}, dependence = {["RAID_FRAMES"] = true, ["raid40FrameFaderRange"] = false}, checkbox = true, groupHeaderName = L["Fader"]})
...
local function LoadRaidPetProfile(panel)
    ...
    addOption(p.scroll.scrollchild, L["Shorten health values"], nil, {getterSetter = "RAID_SHORT_HEALTH_VALUES_PET", callback = function() GW.UpdateGridSettings("RAID_PET") end, dependence = {["RAID_FRAMES"] = true, ["RAID_PET_FRAMES"] = true}})
    ...
    addOptionDropdown(p.scroll.scrollchild, L["Sort Method"], nil, { getterSetter = "RAID_RAID_SORT_METHOD_PET", callback = function() GW.UpdateGridSettings("RAID_PET", true) end, optionsList = {"INDEX", "NAME"}, optionNames = {L["Index"], NAME}, dependence = {["RAID_FRAMES"] = true, ["RAID_PET_FRAMES"] = true, ["RAID_GROUP_BY_PET"] = {"CLASS", "GROUP", "NAME", "ROLE"}}})
...
local function LoadPartyProfile(panel)
    ...
    addOption(party.scroll.scrollchild, L["Shorten health values"], nil, {getterSetter = "RAID_SHORT_HEALTH_VALUES_PARTY", callback = function() GW.UpdateGridSettings("PARTY") end, dependence = {["RAID_FRAMES"] = true, ["RAID_STYLE_PARTY"] = true}})
    ...
    addOptionDropdown(party.scroll.scrollchild, L["Show Country Flag"], L["Display a country flag based on the unit's language"], { getterSetter = "RAID_UNIT_FLAGS_PARTY", callback = function() GW.UpdateGridSettings("PARTY") end, optionsList = {"NONE", "DIFFERENT", "ALL"}, optionNames = {NONE_KEY, L["Different Than Own"], ALL}, dependence = {["RAID_FRAMES"] = true, ["RAID_STYLE_PARTY"] = true}})
    ...
    addOptionDropdown(party.scroll.scrollchild, GW.NewSign .. L["Fader"], nil, { getterSetter = "gridPartyFrameFader", callback = function() GW.UpdateGridSettings("PARTY") end, optionsList = {"casting", "combat", "hover", "dynamicflight", "health"}, optionNames = {L["Casting"], COMBAT, L["Hover"], DYNAMIC_FLIGHT, HEALTH}, dependence = {["RAID_FRAMES"] = true, ["RAID_STYLE_PARTY"] = true, ["gridPartyFrameFaderRange"] = false}, checkbox = true, groupHeaderName = L["Fader"]})
...
local function LoadMaintankProfile(panel)
    ...
    addOption(tank.scroll.scrollchild, L["Shorten health values"], nil, {getterSetter = "RAID_SHORT_HEALTH_VALUES_TANK", callback = function() GW.UpdateGridSettings("TANK") end, dependence = {["RAID_FRAMES"] = true, ["RAID_MAINTANK_FRAMES_ENABLED"] = true}})
    ...
    addOptionDropdown(tank.scroll.scrollchild, L["Show Country Flag"], L["Display a country flag based on the unit's language"], { getterSetter = "RAID_UNIT_FLAGS_TANK", callback = function() GW.UpdateGridSettings("TANK") end, optionsList = {"NONE", "DIFFERENT", "ALL"}, optionNames = {NONE_KEY, L["Different Than Own"], ALL}, dependence = {["RAID_FRAMES"] = true, ["RAID_MAINTANK_FRAMES_ENABLED"] = true}})
    ...
    addOptionDropdown(tank.scroll.scrollchild, GW.NewSign .. L["Fader"], nil, { getterSetter = "gridTankFrameFader", callback = function() GW.UpdateGridSettings("TANK") end, optionsList = {"casting", "combat", "hover", "dynamicflight", "health"}, optionNames = {L["Casting"], COMBAT, L["Hover"], DYNAMIC_FLIGHT, HEALTH}, dependence = {["RAID_FRAMES"] = true, ["RAID_MAINTANK_FRAMES_ENABLED"] = true, ["gridTankFrameFaderRange"] = false}, checkbox = true, groupHeaderName = L["Fader"]})
