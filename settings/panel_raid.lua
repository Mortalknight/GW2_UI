...
local function LoadRaidPanel(sWindow)
    ...
    addOption(p, L["RAID_SHOW_IMPORTANT_RAID_DEBUFFS"], L["RAID_SHOW_IMPORTANT_RAID_DEBUFFS_DESC"], "RAID_SHOW_IMPORTEND_RAID_INSTANCE_DEBUFF", nil, nil, {["RAID_FRAMES"] = true})
