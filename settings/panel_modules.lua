...
local function LoadModulesPanel(sWindow)
    ...
    addOption(p.scroll.scrollchild, BINDING_NAME_TOGGLECHARACTER3, L["Use the GW2 UI improved Pet bar."], "PETBAR_ENABLED", nil, nil, nil, "Actionbars|Bartender4|PetBar")
    ...
    addOption(p.scroll.scrollchild, RAID_FRAMES_LABEL, RAID_FRAMES_SUBTEXT, "RAID_FRAMES", nil, nil, nil, "Raidframes")
    addOption(p.scroll.scrollchild, L["Group Frames"], L["Replace the default UI group frames."], "PARTY_FRAMES", nil, nil, nil, "Groupframes")
