...
local function LoadModulesPanel(sWindow)
    ...
    addOption(p.scroll.scrollchild, COMMUNITIES_ADD_TO_CHAT_DROP_DOWN_TITLE, L["Enable the improved chat window."], {getterSetter = "CHATFRAME_ENABLED", callback = function() GW.ShowRlPopup = true end})
