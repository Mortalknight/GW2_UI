...
local function LoadTargetPanel(sWindow)
    ...
    addOption(p_target, L["Dungeon & Raid Debuffs"], L["Show important Dungeon & Raid debuffs"], "target_BUFFS_FILTER_IMPORTANT", nil, nil, {["TARGET_ENABLED"] = true, ["target_DEBUFFS"] = true})
