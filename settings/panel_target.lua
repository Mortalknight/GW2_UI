...
local function LoadTargetPanel(sWindow)
    ...
    addOption(p_target.scroll.scrollchild, L["Shorten health values"], nil, "TARGET_UNIT_HEALTH_SHORT_VALUES", GW.ToggleTargetFrameSettings, nil, {["TARGET_ENABLED"] = true})
    ...
    addOption(p_focus.scroll.scrollchild, L["Shorten health values"], nil, "FOCUS_UNIT_HEALTH_SHORT_VALUES", GW.ToggleFocusFrameSettings, nil, {["FOCUS_ENABLED"] = true})
