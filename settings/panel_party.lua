...
local function LoadPartyPanel(sWindow)
    ...
    addOption(p, L["RAID_SHOW_IMPORTANT_RAID_DEBUFFS"], L["RAID_SHOW_IMPORTANT_RAID_DEBUFFS_DESC"], "PARTY_SHOW_IMPORTEND_RAID_INSTANCE_DEBUFF", nil, nil, {["PARTY_FRAMES"] = true, ["RAID_STYLE_PARTY"] = false})
    addOption(p, L["PLAYER_GROUP_FRAME"], L["PLAYER_GROUP_FRAME_DESC"], "PARTY_PLAYER_FRAME", nil, nil, {["PARTY_FRAMES"] = true, ["RAID_STYLE_PARTY"] = false})
    addOptionDropdown(
        p,
