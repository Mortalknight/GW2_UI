...
local function LoadPlayerPanel(sWindow)
    ...
    addOption(p_player.scroll.scrollchild, L["Energy/Mana Ticker"], L["5 secound rule: display remaining time"], {getterSetter = "PLAYER_ENERGY_MANA_TICK", PLAYER_ENERGY_MANA_TICK_HIDE_OFC = GW.Update5SrHot,  dependence = {["POWERBAR_ENABLED"] = true}, hidden = GW.Retail})
