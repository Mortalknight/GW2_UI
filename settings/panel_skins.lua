...
local function LoadSkinsPanel(sWindow)
    ...
    addOption(p.scroll.scrollchild, ACHIEVEMENTS, nil, "ACHIEVEMENT_SKIN_ENABLED", function() GW.ShowRlPopup = true end, nil, nil, "AchievementSkin")
    ...
    addOption(p.scroll.scrollchild, GW.NewSign .. "|cffaaaaaa[AddOn]|r PetTracker", nil, "SKIN_PETTRACKER_ENABLED", function() GW.ShowRlPopup = true end)
