...
GW_DEFAULT["WORLD_EVENTS_COMMUNITY_FEAST"] = {
    enabled = true,
    desaturate = false,
    alert = true,
    alertSeconds = 600,
...
GW_DEFAULT["WORLD_EVENTS_COMMUNITY_FEAST_STOP_ALERT_IF_COMPLETED"] = false
...
GW_DEFAULT["WORLD_EVENTS_DRAGONBANE_KEEP_STOP_ALERT_IF_COMPLETED"] = false
