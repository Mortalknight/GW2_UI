...
local function CreateCreditsFrame()
    ...
    CreditsFrame.Section5 = CreateSection(300, 110, CreditsFrame, "TOP", CreditsFrame.Section4, "BOTTOM", 0)
    ...
    CreditsFrame.Section5.Content = CreateContentLines(4, CreditsFrame.Section5, CreditsFrame.Section5.Header)
