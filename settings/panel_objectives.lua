...
local function LoadObjectivesPanel(sWindow)
    ...
    addOptionDropdown(p.scroll.scrollchild, L["Quest Tracker sorting"], nil, { getterSetter = "QUESTTRACKER_SORTING", callback = function() GW.UpdateQuestTracker(GwQuesttrackerContainerQuests) end, optionsList = {"DEFAULT", "LEVEL", "ZONE"}, optionNames = {DEFAULT, GUILD_RECRUITMENT_LEVEL, ZONE .. L[" |cFF888888(required Questie)|r"]}, dependence = {["QUESTTRACKER_ENABLED"] = true}, hidden = not GW.Classic})
