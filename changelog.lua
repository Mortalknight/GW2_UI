...
GW_CHANGELOGS = "\nFIXED\n" .. GW_CHANGELOGS
GW_CHANGELOGS = "   - Add option to move player auras\n" .. GW_CHANGELOGS
...
--VERSION 5.3.0
GW_CHANGELOGS = "   - Settings menu improvements\n" .. GW_CHANGELOGS
GW_CHANGELOGS = "   - Added option to show player health and absorb as %, value or both\n" .. GW_CHANGELOGS
