...
local function ApplyAlliedRacesUISkin()
    ...
    GW.CreateFrameHeaderWithBody(AlliedRacesFrame, AlliedRacesFrameTitleText, "Interface/AddOns/GW2_UI/textures/icons/auction-window-icon", {AlliedRacesFrame.RaceInfoFrame}, nil, false, true)
