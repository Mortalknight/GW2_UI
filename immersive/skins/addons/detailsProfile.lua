...
local function LoadDetailsProfile()
    ...
    instance.row_info.use_spec_icons = false
    instance.row_info.icon_file = "Interface/AddOns/GW2_UI/textures/addonSkins/detailsClassIcons"
    ...
    instance:SetBarTextSettings(12, "GW2_UI_Chat", {1, 1, 1, 1}, false, false, false, false, false, nil, 1, true, false, nil, true, {0, 0, 0, 1}, true, {0, 0, 0, 1})
