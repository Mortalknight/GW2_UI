...
local function SkinMail()
    ...
    MailFrameTab2:SetWidth(300)
    MailFrameTab2:SetText("Compose")
    MailFrameTab2:SetPoint("TOPLEFT", MailItem1, "TOPLEFT", 0, 35)
    MailFrameTab2:SkinButton(false,true)
    MailFrameTab2:SetScript(
        "OnClick",
        function() 
