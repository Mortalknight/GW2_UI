...
local function encounterJournalSkin()
    ...
    GW.HandleAchivementsScrollControls(EncounterJournalEncounterFrameInfoDetailsScrollFrame)
    GW.HandleTrimScrollBar(EncounterJournalEncounterFrameInfoOverviewScrollFrame.ScrollBar, true)
    GW.HandleAchivementsScrollControls(EncounterJournalEncounterFrameInfoOverviewScrollFrame)
