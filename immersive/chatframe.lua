...
function gw_styleChatWindow(i)
    ...
    _G['ChatFrame'..useId..'ButtonTopTexture']:SetTexture(nil)    
    _G['ChatFrame'..useId..'ButtonRightTexture']:SetTexture(nil)    
    _G['ChatFrame'..useId..'ButtonLeftTexture']:SetTexture(nil)    
    _G['ChatFrame'..useId..'ButtonBottomTexture']:SetTexture(nil)    
