...
local function HandleRewardButton(child)
    ...
    if cartButton and not cartButton.text then
        ...
        cartButton.text:GwSetFontTemplate(UNIT_NAME_FONT, GW.Enum.TextSizeType.BigHeader, "OUTLINE", 14)
...
local function SkinPerksProgram()
    ...
    if PerksProgramFrame.ProductsFrame then
        ...
        PerksProgramFrame.ProductsFrame.PerksProgramFilter.Text:GwSetFontTemplate(UNIT_NAME_FONT, GW.Enum.TextSizeType.Small)
        ...
        PerksProgramFrame.ProductsFrame.PerksProgramFilter:SetScript("OnEnter", function(self)
            self.Text:GwSetFontTemplate(UNIT_NAME_FONT, GW.Enum.TextSizeType.Small)
        ...
        if shoppingCart then
            ...
            shoppingCart.ClearCartButton.text:GwSetFontTemplate(UNIT_NAME_FONT, GW.Enum.TextSizeType.BigHeader, "OUTLINE", 24)
