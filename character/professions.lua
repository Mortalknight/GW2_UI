...
local function loadOverview(parent)
    ...
    for i = 1, 5, 1 do
        ...
        fm.btn1.name:SetFont(UNIT_NAME_FONT,GW.settings.FONTS_NORMAL_SIZE,GW.settings.FONTS_OUTLINE)
        ...
        fm.btn2.name:SetFont(UNIT_NAME_FONT,GW.settings.FONTS_NORMAL_SIZE,GW.settings.FONTS_OUTLINE)
