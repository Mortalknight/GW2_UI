...
function gwPaperDollUpdateUnitData()
    ...
    GwDressingRoom.characterData:SetText(LEVEL..' '..unitLevel..' '..localizedClass)

	if name ~= nil then
		local data = LEVEL..' '..unitLevel..' '..name..' '..localizedClass
...
function gwPaperDollStats_OnEvent(self,event,...)
	...
	if ( event == "PLAYER_ENTERING_WORLD" or
		event == "UNIT_MODEL_CHANGED" or event=='UNIT_NAME_UPDATE' or event=="PLAYER_PVP_RANK_CHANGED" and unit == "player" ) then
...
function gwCharacterPanelToggle(frame)
    ...
    if frame:GetName()=='GwPaperReputation'  or frame:GetName()=="GwPetContainer" then GwDressingRoom:Hide() else GwDressingRoom:Show() end
...
--[[NYI    GwPaperDollOutfits:SetScript('OnShow',GwOutfitsDrawItemSetList)
